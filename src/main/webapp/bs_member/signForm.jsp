...
@media screen and (max-width: 300px) {
  .cancelbtn, .signupbtn {
   ...
   <form action="sign.do" name="signForm" method="post" style="border:1px solid #ccc">
 	<div class="container">
     <h1>회원가입</h1>
    <p>Please fill in this form to create an account.</p>
     ...
     <input type="tel" placeholder="Repeat tel" name="phone" required>
   
     <label for="addr"><b>addr</b></label>  
     <input type="text" placeholder="Repeat addr" name="addr" required>
