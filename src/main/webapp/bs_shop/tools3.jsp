...
<%          } %>
   ...
   <div class="container">
      ...
      <ol class="breadcrumb">
         <li class="breadcrumb-item"><a href="../bs_shop/tools_shop.jsp">SHOP</a></li>
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/tool3.JPG" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">하리오 슬림 핸드밀</h2>
                           ...
                           <div class="card-body" style="text-align: right">
                              <div class="container">
                                    ...
                                    <select name="" id="select_price" class="form-control" >
                                       ...
                                       <option value=43000>1</option>
                                       <option value=86000>2</option>
                                       <option value=129000>3</option>
                                       <option value=132000>4</option>
                                    </select>
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="하리오 슬림 핸드밀" readonly>
                        </td>
                        
                        
                        <td style="text-align: right">43,000원</td>
