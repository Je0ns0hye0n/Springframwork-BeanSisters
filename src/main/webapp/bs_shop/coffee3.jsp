...
<%          } %>
   ...
   <div class="container">
      ...
      <ol class="breadcrumb">
         <li class="breadcrumb-item"><a href="../bs_shop/coffee_shop.jsp">SHOP</a></li>
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/coffee3.jpg" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">케냐 루케라AA</h2>
                           ...
                           <div class="card-body" style="text-align: right">
                              <div class="container">
                                    ...
                                    <select name="" id="select_price" class="form-control" >
                                       ...
                                       <option value=21000>1</option>
                                       <option value=42000>2</option>
                                       <option value=63000>3</option>
                                       <option value=84000>4</option>
                                    </select>
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="케냐 루케라AA" readonly>
                        </td>
                        
                        <td style="text-align: right">21,000원</td>
