   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/tool2.JPG" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">에어로프레스</h2>
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="에어로프레스" readonly>
                        </td>
                        
                        
                        <td style="text-align: right">50,000원</td>
