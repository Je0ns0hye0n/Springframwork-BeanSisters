   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/good1.jpg" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">BS계량 글라스</h2>
                  <p class="card-text">강화내열유리 소재로 오렌지 컬러의 눈금표시가 돋보이는 카페 계량 글라스입니다. 
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="BS계량 글라스" readonly>
                        </td>
