   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/coffee4.jpg" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">케냐 응다로이니</h2>
                           ...
                           <div class="card-body" style="text-align: right">
                              <div class="container">
                                    ...
                                    <select name="" id="select_price" class="form-control" >
                                       ...
                                       <option value=18000>1</option>
                                       <option value=36000>2</option>
                                       <option value=54000>3</option>
                                       <option value=72000>4</option>
                                    </select>
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="케냐 응다로이니" readonly>
                        </td>
