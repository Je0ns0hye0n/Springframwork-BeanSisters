   ...
   <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-md-8">
            ...
            <!-- Blog Post -->
            <div class="card mb-4">
               <img class="card-img-top" src="../img/coffe1.jpg" width="700"
                  height="400" alt="Card image cap">
               <div class="card-body">
                  <h2 class="card-title">DAYDREAM</h2>
                  ...
                  <form action="../bs_shop/insertCart.do" method="post" onsubmit="return isLogin();">
                        ...
                        <td>
                        <input type="text" name="c_pro_name" value="데이드림" readonly>
                        </td>
